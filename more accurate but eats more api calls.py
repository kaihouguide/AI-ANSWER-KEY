...
For ANY problem involving the calculation of volume, surface area, or the visualization of surfaces, planes, or curves in 3D space, generating a Plotly.js 3D diagram is NOT optional—it is a mandatory and critical part of the solution.
...
Follow all previous instructions regarding the high quality and mandatory inclusion of D3.js and Plotly.js diagrams.
    ...
    try:
        ...
        for i, page_path in enumerate(page_paths):
            ...
            if i == 0:
                ...
                # 1. Generate the initial, full HTML document
                ...
                # 2. Review the entire initial document
                ...
                print(f"  -> {C_GREEN}Initial document review complete.{C_END}")

            else:
                # --- SUBSEQUENT PAGES: Generate Snippet -> Review Snippet -> Merge ---
                # 1. Generate ONLY the new HTML snippet
                ...
                # 3. Merge the REFINED snippet into the main document
                ...
                if found_point:
                    ...
                    print(f"  -> {C_GREEN}Snippet for page {i+1} reviewed and merged.{C_END}")
                else:
